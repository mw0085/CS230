...
if(isset($_POST['gallery-submit'])){
    ...
    $title = $_POST['title'];
    $descript = $_POST['descript']; //from phpmyadmin
    ...
    if($file_size > 4*MB){
        ...
        if(!mysqli_stmt_prepare($stmt, $sql)){ #sqlInjection check
            ...
            header("Location: ../admin.php?success=GalleryUploadSucess");
            exit();
   ...
   // echo print_r($file);//print file info 
